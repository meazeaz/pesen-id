...
export default function WalletClient({ walletData }: { walletData: WalletData }) {
  ...
  // Helper Menyamarkan Nomor Rekening (Contoh: **** **** 1234)
      ...
      <div className="max-w-7xl mx-auto p-6 lg:p-8 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
           ...
           <div className="space-y-6">
              ...
              {/* Bank Card UI (MENAMPILKAN DATA ASLI) */}
              <div className="bg-slate-900 text-white p-6 rounded-3xl shadow-lg relative overflow-hidden border border-slate-700 h-[210px] flex flex-col justify-between">
                 ...
                 {walletData.bankData ? (
                   // Jika User Sudah Mendaftarkan Bank di Halaman Settings
                   <div className="flex flex-col justify-between h-full gap-6">
                      ...
                      <div className="flex items-center gap-3">
                         ...
                         <p className="font-mono text-lg tracking-widest text-slate-300">
                           {maskAccountNumber(walletData.bankData.accountNumber)}
                         </p>
                      </div>
                   ...
                   // Jika User BELUM Mendaftarkan Bank
                   <div className="flex flex-col items-center justify-center h-full text-center">
                     <p className="text-sm text-slate-400 mb-4">Belum ada rekening pencairan yang ditambahkan.</p>
                     <Link href="/dashboard/settings" className="px-4 py-2 bg-white/10 hover:bg-white/20 rounded-xl text-xs font-bold text-white transition-colors flex items-center gap-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                 <div className="bg-white dark:bg-[#121212] p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
                    ...
                    <p className="text-sm font-bold text-slate-900 dark:text-white">{formatRupiah(walletData.totalIncome)}</p>
                 </div>
                 <div className="bg-white dark:bg-[#121212] p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
                    <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-sm font-bold text-slate-900 dark:text-white">{formatRupiah(walletData.totalExpense)}</p>
                 </div>
              </div>
